...
SECRET_KEY = "LWU{@>sbp$Yz9y/+%<%F*[0~?b@G4(^@a{(!?}E,{Z%0`K!Id,"
...
INSTALLED_APPS = [
    ...
    "channels",
    "mainotebook.system",
    "mainotebook.content",  # 内容管理应用
]

MIDDLEWARE = [
    "mainotebook.utils.middleware.HealthCheckMiddleware",
    ...
    "mainotebook.utils.middleware.ApiLoggingMiddleware",
]
...
# 开发环境使用 Console 后端（邮件打印到控制台）
# 生产环境改为 'django.core.mail.backends.smtp.EmailBackend'
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_FILTER_BACKENDS": (
        ...
        "mainotebook.utils.filters.CustomDjangoFilterBackend",
        "rest_framework.filters.SearchFilter",
        "rest_framework.filters.OrderingFilter",
    ),
    "DEFAULT_PAGINATION_CLASS": "mainotebook.utils.pagination.CustomPagination",  # 自定义分页
    ...
    "EXCEPTION_HANDLER": "mainotebook.utils.exception.CustomExceptionHandler",  # 自定义的异常处理
    "DEFAULT_THROTTLE_RATES": {
        "register": "10/hour",  # 注册接口频率限制
        "resend_verification": "5/hour",  # 重发验证邮件频率限制
    },
}
# ================================================= #
# ******************** 登录方式配置 ******************** #
...
AUTHENTICATION_BACKENDS = ["mainotebook.utils.backends.CustomBackend"]
# ================================================= #
# ****************** simplejwt配置 ***************** #
# ================================================= #
SIMPLE_JWT = {
...
SWAGGER_SETTINGS = {
    ...
    "DEFAULT_AUTO_SCHEMA_CLASS": "mainotebook.utils.swagger.CustomSwaggerAutoSchema",
}
