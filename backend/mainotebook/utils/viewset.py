...
from mainotebook.utils.filters import CoreModelFilterBankend, DataLevelPermissionMargeFilter
from mainotebook.utils.import_export_mixin import ExportSerializerMixin, ImportSerializerMixin
from mainotebook.utils.json_response import SuccessResponse, ErrorResponse, DetailResponse
from mainotebook.utils.permission import CustomPermission
from mainotebook.utils.models import get_custom_app_models, CoreModel
from mainotebook.system.models import FieldPermission, MenuField
...
class CustomModelViewSet(ModelViewSet, ImportSerializerMixin, ExportSerializerMixin, QueryArgumentsMixin):
    ...
    def get_serializer(self, *args, **kwargs):
        ...
        # Swagger 生成 schema 时 request 可能为 None，跳过字段权限逻辑
