...
from mainotebook.system.models import FileList
...
class FileSerializer(CustomModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if file_engine == 'oss':
            from mainotebook.utils.aliyunoss import ali_oss_upload
            ...
            from mainotebook.utils.tencentcos import tencent_cos_upload
