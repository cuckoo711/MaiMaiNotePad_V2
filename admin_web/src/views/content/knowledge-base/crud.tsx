	...
	return {
		crudOptions: {
			...
			actionbar: {
				buttons: {
					add: {
						show: auth('knowledge_base:Create'),
					},
					export: {
						text: '导出',
						title: '导出',
						show: auth('knowledge_base:Export'),
						click: (ctx: any) =>
			...
			rowHandle: {
				...
				buttons: {
					...
					edit: {
						iconRight: 'Edit',
						type: 'text',
						show: auth('knowledge_base:Update'),
					},
					remove: {
						iconRight: 'Delete',
						type: 'text',
						show: auth('knowledge_base:Delete'),
					},
					approve: {
						text: '审核通过',
						type: 'text',
						iconRight: 'Select',
						show: auth('knowledge_base:Approve'),
						click: (ctx: any) =>
