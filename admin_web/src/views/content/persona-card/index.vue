		...
		<el-card>
			<fs-crud ref="crudRef" v-bind="crudBinding" @selection-change="handleSelectionChange">
				...
				<template #actionbar-right>
					...
					<!-- 批量审核通过 -->
					<el-button
						v-if="auth('persona_card:Approve')"
						type="success"
				...
				<template #row-handle="{ row }">
					...
					<el-button
						v-if="auth('persona_card:Approve') && row.is_pending"
						type="text"
						size="small"
...
<script lang="ts" setup name="contentPersonaCard">
...
const filesList = ref<api.PersonaCardFile[]>([]);
...
const handleDelete = (row: any) => {
	ElMessageBox.confirm('确定删除该人设卡吗？', '提示', {
